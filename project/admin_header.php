          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="all_category.php">All Categories</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Brands</span></a>
              <ul class="dropdown-menu">
              <li><a class="nav-link" href="add_brand.php">Add Brand</a></li>
                <li><a class="nav-link" href="all_brand.php">All Brands</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Deals</span></a>
              <ul class="dropdown-menu">
              <li><a class="nav-link" href="add_deal.php">Add Deal</a></li>
                <li><a class="nav-link" href="all_deal.php">All Deals</a></li>
              </ul>
            </li>
